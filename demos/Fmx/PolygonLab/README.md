...
Demo `FMX` para validar la coleccion `TGMMap.Polygons`.

## Que comprueba

- activacion del mapa con `API key`
- creacion de un poligono antes o despues de activar el mapa
...
1. Abrir `GMLibPolygonLabFmx.dproj`.
