...
uses
  ...
  uTest.OSM.Marker.Model in 'src\uTest.OSM.Marker.Model.pas',
  uTest.MapLib.Offline.StyleProvider in 'src\uTest.MapLib.Offline.StyleProvider.pas',
  uTest.MapLib.Offline.TileResolver in 'src\uTest.MapLib.Offline.TileResolver.pas',
  uTest.MapLib.Offline.RegionManager in 'src\uTest.MapLib.Offline.RegionManager.pas',
