...
type
  TGMLibLatLng = uMapLib.Core.LatLng.TMapLibLatLng;
  { Kept here as alias for backward compatibility with existing units and user code. }
  ...
  { Bridge backend alias kept in this unit for compatibility. }
