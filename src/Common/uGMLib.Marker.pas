...
{$ENDIF}
  ...
  TGMPinOptions = class(TGMLibApiObject)
  private
  ...
  TGMHtmlMarkerOptions = class(TGMLibApiObject)
  private
  ...
  TGMLabelMarkerOptions = class(TGMLibApiObject)
  private
    FBackgroundCss: string;
    FBorderColorCss: string;
  ...
  TGMMarkerOptions = class(TGMLibApiObject)
  private
...
procedure TGMMarkerItem.ProcessMapMessage(const AEnvelope: TGMMessageEnvelope);
var
