{**
  @abstract(Modelo de colección de ventanas de información del mapa.)
}
...
type
  ...
  TGMInfoWindowPixelOffset = class(TGMLibApiObject)
  private
    FHeight: Integer;
    FWidth: Integer;
  ...
  TGMInfoWindowOpenOptions = class(TGMLibApiObject)
  private
  ...
  TGMInfoWindowOptions = class(TGMLibApiObject)
  private
    FAriaLabel: string;
    FContent: string;
...
{$IFDEF FPC}
function InfoWindowPayloadAsString(const AEnvelope: TGMMessageEnvelope): string;
begin
...
procedure TGMInfoWindowItem.ProcessMapMessage(const AEnvelope: TGMMessageEnvelope);
var
