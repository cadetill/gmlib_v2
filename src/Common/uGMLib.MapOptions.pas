...
type
  ...
  TGMCustomPositionControlOptions = class(TGMLibApiObject)
  private
  ...
  TGMMapTypeControlOptions = class(TGMLibApiObject)
  private
  ...
  TGMScaleControlOptions = class(TGMLibApiObject)
  private
  ...
  TGMLatLngBounds = class(TGMLibApiObject)
  private
    FEast: Double;
    FHasEast: Boolean;
    FHasNorth: Boolean;
  ...
  TGMMapRestriction = class(TGMLibApiObject)
  private
  ...
  TGMMapOptions = class(TGMLibApiObject)
  private
