{**
  @abstract(Modelo de colecciÃ³n de polÃ­gonos del mapa.)
}
unit uGMLib.Polygon;
...
type
  ...
  TGMPolygonOptions = class(TGMLibApiObject)
  private
    FClickable: Boolean;
    FDraggable: Boolean;
    FEditable: Boolean;
...
procedure TGMPolygonItem.ProcessMapMessage(const AEnvelope: TGMMessageEnvelope);
var
{$IFDEF FPC}
  JsonValue: TJSONData;
{$ELSE}
