{**
  ...
  Esta unidad define un transporte mÃ­nimo para `WebView2`. La integraciÃ³n real
  de mensajes y ciclo de vida se completarÃ¡ en la siguiente iteraciÃ³n.
}
...
procedure TGMLibWebView2Bridge.PostCommand(const AEnvelope: TMapLibMessageEnvelope);
begin
  ExecuteJavaScript(
